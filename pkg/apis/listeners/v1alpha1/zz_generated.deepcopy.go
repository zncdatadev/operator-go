...
func (in *ListenerSpec) DeepCopyInto(out *ListenerSpec) {
	*out = *in
	if in.ExtraPodSelectorLabels != nil {
		in, out := &in.ExtraPodSelectorLabels, &out.ExtraPodSelectorLabels
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodListener) DeepCopyInto(out *PodListener) {
	*out = *in
	if in.ListenerIngresses != nil {
		in, out := &in.ListenerIngresses, &out.ListenerIngresses
		*out = make([]IngressAddressSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodListener.
func (in *PodListener) DeepCopy() *PodListener {
	if in == nil {
		return nil
	}
	out := new(PodListener)
...
func (in *PodListenersSpec) DeepCopyInto(out *PodListenersSpec) {
	*out = *in
	if in.Listeners != nil {
		...
		*out = make(map[string]PodListener, len(*in))
		for key, val := range *in {
