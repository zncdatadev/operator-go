...
func (in *CredentialsScope) DeepCopyInto(out *CredentialsScope) {
	*out = *in
	...
	if in.ListenerVolumes != nil {
		in, out := &in.ListenerVolumes, &out.ListenerVolumes
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleGroupConfigSpec) DeepCopyInto(out *RoleGroupConfigSpec) {
	*out = *in
	if in.Affinity != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleGroupConfigSpec.
func (in *RoleGroupConfigSpec) DeepCopy() *RoleGroupConfigSpec {
	if in == nil {
		return nil
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ZKConfig) DeepCopyInto(out *ZKConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ZKConfig.
func (in *ZKConfig) DeepCopy() *ZKConfig {
	if in == nil {
		return nil
	}
	out := new(ZKConfig)
